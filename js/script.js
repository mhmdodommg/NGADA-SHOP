   ...
   // ربط دالة توجيه المستخدم بعد التأخير بجميع الروابط
    ...
    if (searchInput && resultsContainer && resultsList) {
        searchInput.addEventListener('input', function () {
            ...
            const books = [
{ title: 'أيفون ١١ برو ماكس', url: 'product/product2.html'},
{ title: 'كريم كريفي', url: 'product/product7.html'},
{ title: 'شبشب بيتي', url: 'product/product1.html' },
{ title: 'شبشب بيتي أسود', url: 'product/product4.html' },
{ title: 'فرشاة شعر', url: 'product/product3.html' },
{ title: 'دبدوب كبير', url: 'product/product8.html' },
{ title: 'طلاء اظافر', url: 'product/product5.html'},
{ title: 'حذاء رياضي', url: 'product/product6.html'},
               ];
